...
export async function submitTempoBooking(formData: FormData) {
  try {
    ...
    // Format specialReq to include all the extra fields for the admin panel
    const formattedReq = `
...
Notes: ${specialReqInput || 'None'}
    ...
    await prisma.booking.create({
      data: {
        ...
        children: 0, // Simplifying, can ask separately
